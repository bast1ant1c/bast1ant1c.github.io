...
author: Bast1ant1c
title: HTB active AD
excerpt: "Vamos a resolver la máquina active de HackTheBox. ¡Let's hack!"
date: 2023-01-18
classes: wide
header:
...
La máquina `AD` es nivel “Easy”, sin embargo, el nivel siempre se lo pones tú, al enfrentar estos retos, ¡vamos a ponernos hack!
...
```bash
nmap -p853,88,135,139,389,445,464,593,636,3268,3269,5722,9389,47001,49152,49153,49154,49155,49157,49158,49165,49168,4916 -sCV 10.10.10.100 -oN versions
```
```bash
